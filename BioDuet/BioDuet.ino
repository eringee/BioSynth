...
AudioSynthWaveform       waveform1;      //xy=347,513
...
AudioEffectEnvelope      sine_envelope1;      //xy=731,434
...
AudioFilterStateVariable outputFilter;   //xy=1099,589
AudioOutputAnalog        dac1;           //xy=1241,573
AudioConnection          patchCord1(h_beat_sine_fm2, h_beat_envelope2);
AudioConnection          patchCord2(h_beat_sine_fm1, h_beat_envelope1);
AudioConnection          patchCord3(noise, 0, filter1, 0);
AudioConnection          patchCord4(sine_fm2, sine_envelope2);
AudioConnection          patchCord5(sine_fm1, sine_envelope1);
AudioConnection          patchCord6(sine_fm3, sine_envelope3);
AudioConnection          patchCord7(filter1, 0, ExtraMixer, 1);
AudioConnection          patchCord8(string1, 0, Arp_mixer, 2);
AudioConnection          patchCord9(drum1, 0, Arp_mixer, 3);
AudioConnection          patchCord10(sine_fm4, sine_envelope4);
AudioConnection          patchCord11(h_beat_envelope2, 0, Arp_mixer, 1);
AudioConnection          patchCord12(bassnote, 0, ExtraMixer, 2);
AudioConnection          patchCord13(h_beat_envelope1, 0, Arp_mixer, 0);
AudioConnection          patchCord14(sine_envelope1, 0, SinesMixer, 1);
AudioConnection          patchCord15(sine_envelope3, 0, SinesMixer, 3);
AudioConnection          patchCord16(sine_envelope2, 0, SinesMixer, 2);
AudioConnection          patchCord17(sine_envelope4, 0, mixer4, 1);
AudioConnection          patchCord18(Arp_mixer, 0, ExtraMixer, 0);
AudioConnection          patchCord19(SinesMixer, 0, mixer4, 0);
AudioConnection          patchCord20(ExtraMixer, 0, SinesMixer, 0);
AudioConnection          patchCord21(mixer4, 0, outputFilter, 0);
AudioConnection          patchCord22(outputFilter, 0, dac1, 0);
...
//  h_beat_waveform1.begin(0.4, 1020, WAVEFORM_SINE);  //something below 32Hz displays a clear beating pattern rathern than modulation
 ...
 // waveform1.begin(0.4, 1020, WAVEFORM_SINE); 
  /*
  sine_envelope1.attack(10);            
  sine_envelope1.decay(10);
  sine_envelope1.sustain(0.9);
  sine_envelope1.release(25);

  sine_envelope2.attack(10);            
  sine_envelope2.decay(10);
  sine_envelope2.sustain(0.9);
  sine_envelope2.release(25);

  sine_envelope3.attack(10);            
  sine_envelope3.decay(10);
  sine_envelope3.sustain(0.9);
  sine_envelope3.release(25);

  sine_envelope4.attack(10);            
  sine_envelope4.decay(10);
  sine_envelope4.sustain(0.9);
  sine_envelope4.release(25);*/
